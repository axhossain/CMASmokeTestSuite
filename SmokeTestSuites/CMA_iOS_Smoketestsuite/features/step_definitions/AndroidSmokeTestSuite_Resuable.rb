...
def login_action()
if is_logged_out?
  touch "view:'CustomUITextField' marked:'Username'"
  type_into_keyboard("cma12")
  touch "view:'CustomUITextField' marked:'Password'"
  type_into_keyboard("11111")
  check_text "Secure Login"
  #sleep 5
  wait_for_nothing_to_be_animating
  touch("view:'CustomUIButton' marked:'Text me'")
  check_text "View Accounts"
...
# text methods
def check_text(expected_mark)
  quote = get_selector_quote(expected_mark)
  wait_until(:timeout=>60, :message => "waited to see view marked #{quote}#{expected_mark}#{quote}"){
